    ...
    <div class="container-scroller">
      ...
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
            <a class="navbar-brand brand-logo" href="{{route('adminpage')}}"><h1 style="color:white;">Job Board App</h1></a>
            <a class="navbar-brand brand-logo-mini" href="{{route('adminpage')}}"><img src="{{asset('assets/images/logo-mini.svg')}}" alt="logo" /></a>
          </div>
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link"  href="{{route('post_status_page')}}">
                <span class="icon-bg"><i class="mdi mdi-crosshairs-gps menu-icon"></i></span>
                <span class="menu-title">Post View</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="{{route('employerlist_page')}}">
